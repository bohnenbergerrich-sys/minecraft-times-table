...
export default function Page() {
  ...
  return <main className="page">
    <section className="top"><div><div className="title">MathCraft v0.10.1</div><div className="subtitle">Clear the dungeon. Awaken the boss. Fill the gallery.</div></div><button className="galleryButton" onClick={() => setShowGallery(true)}>🏆</button></section>
